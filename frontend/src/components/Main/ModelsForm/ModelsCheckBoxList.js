...
import ModelsSelectionTabs from "./ModelsSelectionTabs";
    ...
    if (modelsStore.getModelType === MODEL_MULTI_TUMOR) {
      return (
        <div className="alert alert-info my-3">
          If multiple tumor datasets are evaluated, this tool will output
          individual and combined tumor risk estimates.
          <br />
          <br />
          The combined tumor risk estimates will only be relevant for tumors
          from the same study and the model assumes that tumors develop
          independently, eg., one tumor does not progress to or influence the
