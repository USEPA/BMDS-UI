    ...
    <tr className="form-group">
      ...
      <td>
        <FloatInput
          ...
          onChange={(value) =>
            props.saveOptions("confidence_level", value, props.idx)
          }
        />
      </td>
      {props.modelType === mc.MODEL_CONTINUOUS ? (
        props.activeTab !== "loud_bayesian" ? (
          <td>
            <SelectInput
...
export default MCMCOptionsForm;
