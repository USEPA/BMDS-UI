    ...
    if (getModelType === MODEL_CONTINUOUS) {
      rows = [
        ...
        [
          "Adverse Direction",
          getLabel(
            selectedDatasetOptions.adverse_direction,
            adverseDirectionOptions,
          ),
        ],
        [
      ...
      rows = [
        [
          "BMR Type",
          getLabel(selectedModelOptions.bmr_type, dichotomousBmrOptions),
        ],
      ...
      rows = [
        ...
        [
          "Estimate Background",
          checkOrEmpty(selectedModelOptions.estimate_background),
        ],
