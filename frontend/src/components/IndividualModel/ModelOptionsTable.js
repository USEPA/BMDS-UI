...
const restrictionMapping = {
  ...
  2: ["Model Approach", "Toxicr Bayesian"],
};
  ...
  render() {
    ...
    if (dtype == Dtype.DICHOTOMOUS) {
      ...
      data = [
        ...
        [
          "Distribution Type",
          getLabel(model.settings.disttype, distTypeOptions),
        ],
      ...
      data = [
        ...
        [
          ...
          getLabel(
            model.settings.intralitter_correlation,
            intralitterCorrelation,
          ),
        ],
        [
          "Estimate Background",
          checkOrEmpty(model.settings.estimate_background),
        ],
