                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <p className="text-muted">
                                ...
                                well as both frequentist and ToxicR Bayesian models. Depending on
                                the complexity of the analysis, it may take a few minutes to
                            ...
                            {isNestedDichotomous ? (
                                <div className="col-md-8">
                                    ...
                                    <CheckboxInput
                                        ...
                                        onChange={v =>
                                            changeReportOptions(
                                                "additionalNestedDichotomousPlots",
                                                v
                                            )
                                        }
                                    />
