          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <p className="mb-0 text-muted">
                Determines how many individual model outputs should be shown in
                the report. If unchecked, only the user-selected best fitting
                model will be included in the report (if one was selected). If
                checked, all models which were executed will be included.
              </p>
            </div>
            <div>
              {isNestedDichotomous ? (
                <div className="col-md-8">
                  <LabelInput
                    label="Include additional plots"
                    htmlFor="additionalNestedDichotomousPlots"
                  />
                  <br />
                  <CheckboxInput
                    id="additionalNestedDichotomousPlots"
                    checked={wordReportOptions.additionalNestedDichotomousPlots}
                    onChange={(v) =>
                      changeReportOptions("additionalNestedDichotomousPlots", v)
                    }
                  />
                  <p className="mb-0 text-muted">
                    Include additional nested dichotomous plots.
                  </p>
                </div>
              ) : null}
            </div>
            {isMultiTumorOrNestedDichotomous ? null : (
              <div className="col-md-4">
                ...
                />
                <p className="text-muted">
                  Include the BMD cumulative distribution function (CDF) table
                  for each model. This is a large table and makes the report
