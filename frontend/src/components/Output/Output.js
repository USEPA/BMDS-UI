...
class Output extends Component {
    renderDataset() {
        ...
        return (
            <div>
                <DatasetTable dataset={outputStore.selectedDataset} footnotes={footnote} />
            </div>
        );
    }
        ...
        return (
            <div className="container-fluid mb-3">
                ...
                <div className="row py-2">
                    ...
                    <div className={outputStore.outputs.length > 1 ? "col-lg-4" : "col-lg-5"}>
              ...
              model-averaged BMD"
                ...
                <div>{outputStore.showNestedModal ? <AdditionalNestedPlotsModal /> : null}</div>
            </div>
        );
    }
}
