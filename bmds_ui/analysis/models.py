...
class Analysis(models.Model):
    ...
    def execute(self):
        """
        Execute analysis, build outputs payload, validate/sanitize to ensure
        SQLite JSON_VALID passes, and log concise summaries of invalid data.
        """
...
>>>>>>> d10170ea0e00259beef1bca28f8eb3f4d3d8be6f
        self.ended = now()
